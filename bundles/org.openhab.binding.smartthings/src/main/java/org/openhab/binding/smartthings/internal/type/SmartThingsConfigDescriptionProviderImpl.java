 ...
 */
@NonNullByDefault
@Component(service = { SmartThingsConfigDescriptionProvider.class, ConfigDescriptionProvider.class })
public class SmartThingsConfigDescriptionProviderImpl implements SmartThingsConfigDescriptionProvider {

 ...
 */
@NonNullByDefault
@Component(service = { SmartThingsChannelGroupTypeProvider.class, ChannelGroupTypeProvider.class })
public class SmartThingsChannelGroupTypeProviderImpl implements SmartThingsChannelGroupTypeProvider {

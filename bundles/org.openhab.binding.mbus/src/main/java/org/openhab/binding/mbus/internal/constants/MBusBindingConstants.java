 ...
 */
package org.openhab.binding.mbus.internal.constants;
 ...
 */
@NonNullByDefault
public class MBusBindingConstants {

    public static final String BINDING_ID = "mbus";

    public static final String CONFIG_DESCRIPTION_URI_CHANNEL = "channel-type:mbus:config";
    ...
    public static final ThingTypeUID THING_TYPE_MBUSTCPGATEWAY = new ThingTypeUID(BINDING_ID, "mbustcpgateway");
    public static final ThingTypeUID THING_TYPE_MBUSCOUNTER = new ThingTypeUID(BINDING_ID, "mbuscounter");

    public static final String PROPERTY_VENDOR_NAME = "ADFWeb";

 ...
 */
package org.openhab.binding.audio.internal.discovery;
 ...
 */
@Component(service = { AudioDiscoveryParticipant.class })
@NonNullByDefault
public class AudioDiscoveryParticipant implements UpnpDiscoveryParticipant {
    ...
    public @Nullable ThingUID getThingUID(RemoteDevice device) {
        ...
        if ("MediaRenderer".equalsIgnoreCase(deviceType)) {
            ...
            ThingTypeUID thingTypeUID = THING_TYPE_INTERNAL_AUDIO;
            ...
            ThingTypeUID thingTypeUID = THING_TYPE_WEB_AUDIO;
            result = new ThingUID(thingTypeUID, device.getIdentity().getUdn().getIdentifierString());
        }
        return result;
    }
